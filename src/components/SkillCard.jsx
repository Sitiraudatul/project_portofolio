...
export default function SkillCard({ title, image, description }) {
  ...
  return (
    <div className="w-full mb-6 lg:pt-[50px] lg:ml-[50px]">
      <div
        className="bg-white hover:bg-purple-500 transition duration-300 h-full justify-center items-center flex flex-col rounded-lg overflow-hidden relative p-5 cursor-pointer"
        onClick={openModal}
      >
        {/* Gambar */}
